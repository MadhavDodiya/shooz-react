    ...
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                        ...
                        <div className="relative flex justify-center cursor-pointer group">
                            <img src="../assets/image/imgi_31_col-5.png" alt="" className="w-full object-cover" />
          ...
          group-hover:bg-pink-500 group-hover:text-white transition">
                        ...
                        {/* CARD */}
                        <div className="relative flex justify-center cursor-pointer group">
                            <img src="../assets/image/imgi_32_col-6.png" alt="" className="w-full object-cover" />
                            <button className="absolute bottom-6 bg-gray-50 text-black px-6 py-2 text-sm font-medium 
          group-hover:bg-pink-500 group-hover:text-white transition">
                        ...
                        {/* CARD */}
                        <div className="relative flex justify-center cursor-pointer group">
                            <img src="../assets/image/imgi_29_col-1.png" alt="" className="w-full object-cover" />
                            <button className="absolute bottom-6 bg-gray-50 text-black px-6 py-2 text-sm font-medium 
          group-hover:bg-pink-500 group-hover:text-white transition">
                        ...
                        {/* CARD */}
                        <div className="relative flex justify-center cursor-pointer group">
                            <img src="../assets/image/imgi_30_col-2.png" alt="" className="w-full object-cover" />
                            <button className="absolute bottom-6 bg-gray-50 text-black px-6 py-2 text-sm font-medium 
          group-hover:bg-pink-500 group-hover:text-white transition">
                                Sandals & Slides 8
                            </button>
                    ...
                    {[1, 2, 3].map((col) => (
                        <div key={col} className="space-y-6">
                            ...
                            <div className="flex gap-4 items-start border-b border-gray-300 pb-4">
                                <img
                                    src="../assets/image/product-3_be4a38ab-621f-46d5-a126-3488687e10f6.avif"
                                    alt=""
                            ...
                            <div className="flex gap-4 items-start border-b border-gray-300 pb-4">
                                <img
                                    src="../assets/image/product-17.avif"
                                    alt=""
                                    className="w-20 h-20 object-cover"
                                />
                                <div>
                            ...
                            <div className="flex gap-4 items-start">
                                <img
                                    src="../assets/image/imgi_58_product-18_31b99edb-0192-4e99-a026-cbd70e3a5624.jpg"
                                    alt=""
                                    className="w-20 h-20 object-cover"
                                />
                                <div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="flex justify-center">
                            <img
                                src="../assets/image/imgi_38_video-pic.png"
                                alt="Shoes"
            ...
            <div className="relative max-w-7xl mx-auto px-4" style={{ top: "-100" }}>
                <div className="flex flex-col md:flex-row overflow-hidden rounded-md">
                    ...
                    <div className="flex-1">
                        <img src="../assets/image/newslatter-image.jpg" alt="Sneaker" className="w-full h-64 md:h-full object-cover" />
                    </div>
                </div>
            </div>
        </>
