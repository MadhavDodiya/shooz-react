    ...
    <Headers />
      <div className="container-fluid bgimg1">
        ...
        <div className="flex justify-center mt-10">
            <div id="tabs" className="flex gap-12 border-b border-gray-300">
                <button className="tab-btn pb-3 text-sm font-semibold tracking-wide text-gray-500" id='feature'>FEATURED</button>
                <button className="tab-btn pb-3 text-sm font-semibold tracking-wide text-gray-500" id='new'>NEW ARRIVALS</button>
                <button className="tab-btn pb-3 text-sm font-semibold tracking-wide text-gray-500" id='best'>BEST SELLER</button>
            </div>
        </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-3">
                        <div className="container-fluid">
                            <img src="../assets/image/imgi_63_product-4_a9f5532a-47cd-4f32-8958-57ee765f0a27.png" className='h-50' alt="" />
